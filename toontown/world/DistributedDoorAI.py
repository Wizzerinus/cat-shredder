...
class DistributedDoorAI(DistributedObjectAI.DistributedObjectAI):
    def __init__(self, air, blockNumber, doorType, doorIndex=0, swing=3):
        ...
        self.fsm = ClassicFSM.ClassicFSM(
            ...
            [
                State.State("off", self.enterOff, self.exitOff, ["closing", "closed", "opening", "open"]),
        ...
        self.exitDoorFSM = ClassicFSM.ClassicFSM(
            ...
            [
                State.State(
                    "off", self.exitDoorEnterOff, self.exitDoorExitOff, ["closing", "closed", "opening", "open"]
                ),
                ...
                State.State("open", self.exitDoorEnterOpen, self.exitDoorExitOpen, ["closing", "open"]),
            ],
            "off",
            "off",
        )
    ...
    def requestEnter(self):
        ...
        if lockedVal:
            ...
            self.sendUpdateToAvatarId(
                avatarID, "setOtherZoneIdAndDoId", [self.getDestinationZone(), self.otherDoor.getDoId()]
            )

    def getDestinationZone(self):
        return self.otherDoor.getZoneId()
