...
class DistributedElevatorAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def __init__(self, air, bldg, numSeats=4):
        ...
        self.fsm = ClassicFSM.ClassicFSM(
            ...
            [
                ...
                State.State(
                    "waitCountdown", self.enterWaitCountdown, self.exitWaitCountdown, ["waitEmpty", "allAboard"]
                ),
    ...
    def clearEmptyNow(self, seatIndex):
        self.sendUpdate("emptySlot" + str(seatIndex), [0, 0, globalClockDelta.getRealNetworkTime(), 0])
