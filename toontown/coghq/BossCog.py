...
from toontown.toonbase.PropPool import createParticleEffect, globalPropPool
...
class BossCog(Avatar.Avatar):
    ...
    notify = directNotify.newCategory("BossCog")
    ...
    def generateBossCog(self):
        ...
        self.doorA = self.__setupDoor(
            ...
            VBase3(0, 0, 0),
            VBase3(0, 0, -80),
            CollisionPolygon(Point3(5, -4, 0.32), Point3(0, -4, 0), Point3(0, 4, 0), Point3(5, 4, 0.32)),
        )
        ...
        self.doorB = self.__setupDoor(
            ...
            VBase3(0, 0, 0),
            VBase3(0, 0, 80),
            CollisionPolygon(Point3(-5, 4, 0.84), Point3(0, 4, 0), Point3(0, -4, 0), Point3(-5, -4, 0.84)),
        )
    ...
    def generateHealthBar(self):
        ...
        glow = globalPropPool.getProp("glow")
    ...
    def __setupDoor(self, jointName, name, callback, openedHpr, closedHpr, cPoly):
        ...
        cnode.setCollideMask(PieBitmask | WallBitmask | CameraBitmask)
    ...
    def getAnim(self, anim):
        ...
        if anim is None:
            ...
            ival = Parallel(
                SoundInterval(self.downSfx, node=self), self.getAngryActorInterval("Fb_down2Up", playRate=-1)
            )
            ...
            ival = Parallel(
                Sequence(SoundInterval(self.throwSfx, node=self), duration=0), self.getAngryActorInterval("Fb_UpThrow")
            )
            ...
            pe = createParticleEffect("bossCogFrontAttack")
            ...
            if self.forward:
                ival = Sequence(
                    ...
                    ParallelEndTogether(
                        ival, self.pelvis.hprInterval(0.5, self.pelvisForwardHpr, blendType="easeInOut")
                    ),
                )
            ...
            ival = Parallel(
                ...
                Sequence(
                    SoundInterval(self.swishSfx, duration=1.1, node=self), SoundInterval(self.boomSfx, duration=1.9)
                ),
