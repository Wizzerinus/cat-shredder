...
from toontown.toontowngui import TTDialog, ToonHeadDialog
...
class BoardingGroupInviterPanels:
    ...
    notify = directNotify.newCategory("BoardingGroupInviterPanels")
...
class BoardingGroupInviterPanelBase(ToonHeadDialog.ToonHeadDialog):
    ...
    notify = directNotify.newCategory("BoardingGroupInviterPanelBase")
...
class BoardingGroupInvitingPanel(BoardingGroupInviterPanelBase):
    ...
    notify = directNotify.newCategory("BoardingGroupInvitingPanel")
...
class BoardingGroupInvitationRejectedPanel(BoardingGroupInviterPanelBase):
    ...
    notify = directNotify.newCategory("BoardingGroupInvitationRejectedPanel")
