...
class BodyShop(StateData.StateData):
    ...
    def __swapSpecies(self, offset):
        ...
        self.__updateScrollButtons(
            self.speciesChoice, length, self.speciesStart, self.speciesLButton, self.speciesRButton
        )
    ...
    def __updateHead(self):
        self.__updateScrollButtons(
            self.headChoice, len(self.headList), self.headStart, self.headLButton, self.headRButton
        )
    ...
    def __changeSpeciesName(self, species):
        self.speciesFrame["text"] = ToonDNA.getSpeciesName(species).title()
