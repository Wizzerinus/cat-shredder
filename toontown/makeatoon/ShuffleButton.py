...
class ShuffleButton:
    notify = directNotify.newCategory("ShuffleButton")
    ...
    def load(self):
        ...
        self.parentFrame = DirectFrame(
            parent=self.parent.parentFrame, relief=DGG.RAISED, pos=(0, 0, -1), frameColor=(1, 0, 0, 0)
        )
    ...
    def startShowLerp(self):
        self.showLerp = Sequence(
            Parallel(Func(self.shuffleFrame.show), Func(self.incBtn.show), Func(self.decBtn.show)),
